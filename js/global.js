(function ($) {
    ...
    $.fn.introSlider = function(options) {
        ...
        this.each(function(index, value){
            ...
            window.onload = function () {
                $item.find('[data-home-animate]').css('visibility', 'hidden');
                $item.find('[data-home-animate]').each(function () {
                    var aniamteClass = $(this).data('home-animate');
                    var aniamteDelay = $(this).data('home-delay');
    ...
    introSelector.each(function () {
        ...
        for (var k in option) {
            if (option.hasOwnProperty(k)) {
                if ($(this).attr('data-home-' + k) != null) {
                    option[k] = $(this).data('home-' + k);
                }
            }
        }
        $(this).introSlider({
